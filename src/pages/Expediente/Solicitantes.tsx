...
import {
  SolicitanteProvider,
  useSolicitante,
} from "../../context/Expedientes/SolcitanteContext";
...
const SolicitantesContent = () => {
  const { solicitantes, loading, handleSearch } = useSolicitante();
  ...
  if (loading)
    return <div className="p-8 text-center">Cargando solicitantes...</div>;

  return (
    <div className="overflow-y-auto h-[calc(100vh-100px)]">
      <div className="flex justify-between py-5 px-7 items-center">
        <div className="flex flex-col">
          <span className="text-2xl font-bold">Solicitantes</span>
