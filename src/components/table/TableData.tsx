...
export const TableData = ({
  ...
  // Ejecutar búsqueda cuando cambie el debounce o el campo seleccionado
  useEffect(() => {
    if (searchConfig?.onSearch) {
      searchConfig.onSearch(debouncedSearch, selectedSearchField);
    }
  }, [debouncedSearch, selectedSearchField]);
    ...
    <>
      ...
      <div className="flex justify-between items-start lg:items-center flex-col md:flex-row gap-4 mb-2">
        ...
        {searchable && searchConfig && (
          <div className="flex w-full max-w-[700px] gap-2">
            ...
            <div className="relative w-full flex max-h-[40px] items-center">
      ...
      <div className="flex items-center justify-between mb-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {groupByField && (
            <Badge variant="secondary" className="flex items-center gap-1 mb-0">
        ...
        <Table>
          ...
          <TableBody>
            {paginatedData.length === 0 ? (
              <TableRow>
                <TableCell
                  colSpan={autoDetectedColumns.length + 1}
              ...
              paginatedData.map((row, rowIndex) =>
                row.__isGroupRow ? (
                  ...
                  <TableRow key={rowIndex}>
                    {autoDetectedColumns.map((column: any) => {
                      const type =
                      ...
                      {renderActions ? (
                        ...
                        <Popover>
                          ...
                          <PopoverContent
                            ...
                            align="center"
                          >
                            <Label className="text-neutral-400 p-3">
                              Sin acciones
                            </Label>
                          </PopoverContent>
                        </Popover>
